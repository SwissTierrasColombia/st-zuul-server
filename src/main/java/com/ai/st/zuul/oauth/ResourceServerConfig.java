...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/workspaces/v1/departments").hasAnyRole(ROLE_ADMINISTRATOR, ROLE_MANAGER, ROLE_SUPPLY_SUPPLIER)
                .antMatchers(HttpMethod.GET, "/api/workspaces/v1/departments/{departmentId}/municipalities").hasAnyRole(ROLE_ADMINISTRATOR, ROLE_MANAGER, ROLE_SUPPLY_SUPPLIER)
                ...
                .antMatchers(HttpMethod.GET, "/api/workspaces/v1/managers/operators").hasAnyRole(ROLE_MANAGER)
                // integrations module
                ...
                .antMatchers(HttpMethod.GET, "/api/providers-supplies/v1/reports/supplies-delivered-snr").hasAnyRole(ROLE_SUPPLY_SUPPLIER)
                .antMatchers(HttpMethod.GET, "/api/providers-supplies/v2/pending-requests").hasAnyRole(ROLE_SUPPLY_SUPPLIER)
                .antMatchers(HttpMethod.GET, "/api/providers-supplies/v2/attended-requests").hasAnyRole(ROLE_SUPPLY_SUPPLIER)
                ...
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/status/delivered").hasAnyRole(ROLE_OPERATOR)
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/status/review").hasAnyRole(ROLE_OPERATOR, ROLE_MANAGER)
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/status/remediation").hasAnyRole(ROLE_MANAGER)
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/status/accepted").hasAnyRole(ROLE_MANAGER)
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/status/rejected").hasAnyRole(ROLE_MANAGER)
                .antMatchers(HttpMethod.POST, "/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/attachments/{attachmentId}/start-quality").hasAnyRole(ROLE_MANAGER)
                .antMatchers(HttpMethod.PUT, "/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/attachments/{attachmentId}/report").hasAnyRole(ROLE_MANAGER)
                .antMatchers(HttpMethod.GET, "/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/attachments/{attachmentId}/report-download").hasAnyRole(ROLE_MANAGER)
                ...
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/status/accepted").hasAnyRole(ROLE_MANAGER)
                .antMatchers(HttpMethod.PATCH, "/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/status/rejected").hasAnyRole(ROLE_MANAGER)
                ...
                .antMatchers(HttpMethod.GET, "/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/feedbacks/{feedbackId}/download").hasAnyRole(ROLE_MANAGER, ROLE_OPERATOR)
                ...
                .antMatchers(HttpMethod.PATCH, "/api/sinic/v1/deliveries/{deliveryId}/status").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/sinic/v1/groups").hasAnyRole(ROLE_ADMINISTRATOR)
                .antMatchers(HttpMethod.PUT, "/api/sinic/v1/groups/{groupId}").hasAnyRole(ROLE_ADMINISTRATOR)
                .antMatchers(HttpMethod.POST, "/api/sinic/v1/groups").hasAnyRole(ROLE_ADMINISTRATOR)
